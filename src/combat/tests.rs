...
mod tests {
    ...
    test_with_world!(test_combat_damage_application, {
        // Set up entities
    ...
    test_with_world!(test_hero_vs_monster_combat_scenario, {
        let (hero, monster) =
        ...
        let monster_health = monster_health_mut.get_mut::<Health>().unwrap();
    ...
    test_with_world!(test_adjacent_position_check, {
    ...
    test_with_world!(test_combat_with_different_damage_values, {
        let attacker = world
            .spawn((
    ...
    test_with_world!(test_combat_state_persistence, {
    ...
    test_with_world!(test_hero_kill_tracking, {
    ...
    fn test_combat_event_fields() {
        ...
        let defender = Entity::from_raw(200);
        let damage = 42;
        ...
        assert_eq!(event._attacker, attacker);
        assert_eq!(event.defender, defender);
        assert_eq!(event.damage, damage);
    }

    test_with_world!(test_multiple_entities_combat, {
