...
#[test]
fn test_ui_state_update_with_hero() {
...
#[test]
fn test_ui_state_update_without_hero() {
    let mut world = create_test_world();
    let mut ui_state = UIState::default();
    let turn_system = TurnSystem::default();
...
#[test]
fn test_ui_state_needs_update_hero_changes() {
    let mut world = create_test_world();
    let mut ui_state = UIState::default();
    let turn_system = TurnSystem::default();
...
#[test]
fn test_ui_state_hero_appearance_disappearance() {
    let mut world = create_test_world();
    let mut ui_state = UIState::default();
    let turn_system = TurnSystem::default();
